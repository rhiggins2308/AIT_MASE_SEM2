...
public class UsingSets {
	...
	private static void linkedHashSet() {
		 ...
		 * chaotic ordering provided by HashSet, wothout incurring the increased cost associated with TreeSet		 * 
		 */
...
class Contact {
	...
	@Override
	public boolean equals(Object obj) {		// same instance variable used as in equals()
		if (obj instanceof Contact) {
			Contact otherContact = (Contact) obj;
			return this.name.contentEquals(otherContact.name) && this.age == otherContact.age;
		}
