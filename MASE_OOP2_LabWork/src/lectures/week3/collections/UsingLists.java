...
//		linkedList();
	...
	public static void factoryMethods() {
		...
		// Demonstrating the "backed" principle
...
//		asList.add("Foxtrot");							// UnsupportedOperationException
	...
	public static void stack() {
		// Stack is a LIFO structiure (Last In First Out) - We can manipulate one end only
		// Using the Stack type as the reference type, gives us access to the push(), pop() and peek() methods
